...
const pegarEventosNaLocalidade = async (cidade: string, uf: string): Promise<Evento[] | Mensagem> => {
    try{
        const resposta = await fetch(`${BACKEND_API_URL}/eventos/${cidade}/${uf}`, {
            method: "GET",
            headers: {
...
export { pegarEventosNaLocalidade };
